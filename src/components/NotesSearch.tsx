                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-2 px-3 py-2 rounded-lg border border-border bg-card text-foreground text-sm hover:bg-accent transition-colors"
                    >
